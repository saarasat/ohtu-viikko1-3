...
public class KassapaateTest {
    ...
    public void kortiltaEiVelotetaJosRahaEiRiita() {
        ...
        verify(kortti, times(1)).getSaldo();
        verify(kortti, times(0)).osta(4);
    }

    @Test
    public void lataaminenMaksukortilleOnnistuuJosSummaOnPositiivinen() {
    ...
    @Test
    public void lataaminenMaksukortilleEiTeeMitäänJosSummaOnNegatiivinen() {
        kassa.lataa(kortti, -5);
